...
const CASES: &[Case] = &[
    ...
    Case {
        ...
        config: "",
        conformant: true,
        codes: &["topology/no-orphan-concepts"],
    },
    Case {
        name: "relative-links",
        config: "",
        conformant: true,
        codes: &["linking/prefer-absolute-links"],
    },
    Case {
        name: "type-casing",
        config: "",
        ...
        codes: &["type-vocabulary/consistent-type-casing", "type-vocabulary/no-singleton-type"],
    },
    Case {
        name: "sparse-frontmatter",
        config: "",
        conformant: true,
        codes: &["frontmatter/require-description", "frontmatter/require-timestamp"],
    },
    Case {
        name: "bad-timestamp",
        config: "",
        conformant: true,
        codes: &["frontmatter/timestamp-iso8601"],
    },
    Case {
        name: "prose-wall",
        config: "",
        conformant: true,
        codes: &["body/structural-body"],
    },
    ...
    Case {
        ...
        conformant: true,
        codes: &["linking/no-dangling-links"],
    },
    Case {
        name: "hub-overflow",
        config: "rules:\n  topology/max-out-degree:\n    severity: warn\n    options: { max: 2 }\n",
        conformant: true,
        codes: &["topology/max-out-degree"],
    },
    // additional rules
    Case { name: "self-link", config: "", conformant: true, codes: &["linking/no-self-link"] },
    Case { name: "singleton-type", config: "", conformant: true, codes: &["type-vocabulary/no-singleton-type"] },
    Case { name: "empty-values", config: "", conformant: true, codes: &["frontmatter/no-empty-frontmatter-values"] },
    Case { name: "empty-body", config: "", conformant: true, codes: &["body/body-not-empty"] },
    Case { name: "unindexed", config: "", conformant: true, codes: &["topology/no-unindexed-concepts"] },
    Case { name: "log-order", config: "", conformant: true, codes: &["index-log/log-newest-first"] },
    Case {
        name: "index-entry-no-desc",
        config: "",
        conformant: true,
        codes: &["index-log/index-entry-has-description"],
    },
    // off-by-default rules demonstrated by reusing a fixture with a config
    Case {
        name: "relative-links",
        config: "rules:\n  linking/no-relative-links: warn\n",
        conformant: true,
        codes: &["linking/prefer-absolute-links", "linking/no-relative-links"],
    },
    Case {
        name: "singleton-type",
        config: "rules:\n  type-vocabulary/no-singleton-type: \"off\"\n  type-vocabulary/types-from-allowlist:\n    severity: error\n    options: { allow: [Alpha] }\n",
        conformant: true,
        codes: &["type-vocabulary/types-from-allowlist"],
    },
];
